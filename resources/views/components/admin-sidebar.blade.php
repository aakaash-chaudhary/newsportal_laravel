<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="dropdown">
            <a href="index.html" class="nav-link"><i data-feather="book-open"></i><span>Articl</span></a>
        </li>

        <li class="dropdown">
            <a href="index.html" class="nav-link"><i data-feather="image"></i><span>Adverstise</span></a>
        </li>
        {{-- <li class="dropdown">
